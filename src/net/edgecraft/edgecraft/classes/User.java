...
public class User {
	...
	/**
	 * Gibt die eingestellte User-Sprache zur�ck
	 * @return String
	 */
	...
	/**
	 * Gibt zur�ck, ob Spieler gebannt ist
	 * @return true/false
	 */
	...
	/**
	 * Gibt den Grund der evtl. vorhandenen Bannung zur�ck
	 * @return String
	 */
	...
	/**
	 * Gibt den zugeh�rigen Bukkit-Player zur�ck
	 * @return Player
	 */
	...
	/**
	 * Gibt den Channel zur�ck, in welchem der Spieler schreibt
	 * @return Channel
	 */
