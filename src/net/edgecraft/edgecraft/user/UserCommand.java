...
public class UserCommand extends AbstractCommand {
	...
	public void sendUsage(CommandSender sender) {
		...
		if( !(sender instanceof Player) || Level.canUse( users.getUser( ((Player)sender).getName()), getLevel()) ) {
			sender.sendMessage(EdgeCraft.usageColor + "/user register <name>");
			sender.sendMessage(EdgeCraft.usageColor + "/user delete <id>");
			sender.sendMessage(EdgeCraft.usageColor + "/user exists <user>");
